...
class ListPrayersPage extends StatefulWidget {
  const ListPrayersPage({super.key});

  @override
  State<ListPrayersPage> createState() => _ListPrayersPageState();
}

class _ListPrayersPageState extends State<ListPrayersPage> {
  ...
  loadPrayers() {
    context.read<PrayerBloc>().add(LoadPrayingEvent());
  }
